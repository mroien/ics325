...
$result = $connection->query("SELECT * FROM users WHERE id = " . intval($_GET['id']));
...
if (isset($_POST['update'])) {
    $update = "UPDATE users SET fname='" . addslashes($_POST['fname']) . "', lname='" . addslashes($_POST['lname']) .
        ...
        "', username='" . addslashes($_POST['username']) . "', admin='" . addslashes($_POST['admin']) . "'WHERE id= " . intval($_GET['id']);
    ...
    header("Location: editUsers.php?id=" . intval($_GET['id']));
}
