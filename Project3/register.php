...
<html>
    ...
    <form class="form" method="post" action="">
        ...
        <label>
            ...
            <input type="radio" name="list" value="YES, I love spam" title="radio" checked required><label>Yes</label>
            <input type="radio" name="list" value="NO, leave me alone" title="radio" required><label>No</label><br/>
        </label>
        ...
        <label>
            Comments
        <textarea rows="4" cols="40" name="textarea" placeholder="maximum of 200 characters" pattern="[\w\D]{,200}">
        </textarea>
        </label><br />
        <label>
