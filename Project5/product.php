...
<table>
    ...
    <tr>
        <td>
            Product ID: <?php echo $prod_id; ?><br/>
            ...
            <form method="post" action="AddtoCart.php?prod_name=<?php echo $prod_name ?>">
                <input type="submit" value="Add Quantity" <?php if (strcmp($_SESSION['availability'], 'false') == 0) {
                    echo "disabled";
                } ?>/>
            </form>
        <td>
