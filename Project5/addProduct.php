...
if (isset($_POST['submitted'])) {
    if (is_uploaded_file($_FILES['aFile']['tmp_name'])) {
        ...
        move_uploaded_file($_FILES['aFile']['tmp_name'],
            "C:/MAMP/htdocs/Project5/product/images/" . $realName);
        ...
        if (mysqli_query($connection, $sql)) {
            ...
            header("Refresh:1; url=http://localhost/project5/adminPage.php", true, 303);
        } else {
...
<form method="post" action="<? $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data">
    ...
    Name: <input type="text" name="prod_name" placeholder="Product Name" pattern="[a-zA-Z0-9 ]+" required/><br/>
